...
public class EmailService {
    ...
    public void enviarEmailBienvenidaYValidacion(String toEmail, String nombre, String apellido, String tokenValidacion) {
        ...
        String jsonBody = String.format("""
            ...
            """, fromEmail, toEmail, nombre, apellido, validacionUrl, validacionUrl);
        ...
        String jsonBody = String.format("""
            {
                ...
                "html": "<div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'><h2 style='color: #2E86AB;'>Recordatorio de Contraseña</h2><p>Hola <strong>%s %s</strong>,</p><p>Has solicitado un recordatorio de tu contraseña para acceder al sistema del Consultorio Cosmos.</p><div style='background-color: #f4f4f4; padding: 20px; border-radius: 5px; margin: 20px 0;'><p style='margin: 0;'><strong>Tu contraseña es:</strong></p><p style='font-size: 24px; color: #2E86AB; font-weight: bold; margin: 10px 0;'>%s</p></div><p><strong>⚠️ Importante:</strong> Por seguridad, te recomendamos cambiar tu contraseña después de iniciar sesión.</p><p style='text-align: center; margin-top: 30px;'><a href='%s' style='background-color: #2E86AB; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold;'>Ir al Sistema</a></p><hr style='border: none; border-top: 1px solid #eee; margin-top: 30px;'><p style='color: #666;'>Si no solicitaste este recordatorio, por favor ignora este mensaje o contacta con el administrador.</p><p><strong>Atentamente,</strong><br>Equipo del Consultorio Cosmos<br><span style='color: #2E86AB;'>consultorio.cosmos@gmail.com</span></p></div>"
            }
            """, fromEmail, toEmail, nombre, apellido, password, baseUrl);
